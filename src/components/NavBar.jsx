  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            {showSearchResult && searchResult.length > 0 && (
              <div className="absolute mt-2 w-72 right-0 md:left-0 md:right-auto bg-neutral-800 rounded-lg shadow-lg overflow-hidden z-50">
            ...
            <button
              className="md:hidden text-white hover:text-purple-400 focus:outline-none flex-shrink-0"
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <nav className="md:hidden mt-4 pt-4 pb-2 border-t border-neutral-800 flex flex-col space-y-4">
            <Link
              to="/home"
              className="text-white hover:text-purple-400 font-medium px-2 py-1 rounded-md hover:bg-neutral-800/50"
            ...
            <a
              href="#trending"
              className="text-white hover:text-purple-400 font-medium px-2 py-1 rounded-md hover:bg-neutral-800/50 block"
              onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('trending')?.scrollIntoView({ behavior: 'smooth' }); }}
            >
              Trending
            </a>
            <a
              href="#popular"
              className="text-white hover:text-purple-400 font-medium px-2 py-1 rounded-md hover:bg-neutral-800/50 block"
              onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('popular')?.scrollIntoView({ behavior: 'smooth' }); }}
            >
              Popular
            </a>
            <a
              href="#top-rated"
              className="text-white hover:text-purple-400 font-medium px-2 py-1 rounded-md hover:bg-neutral-800/50 block"
              onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('top-rated')?.scrollIntoView({ behavior: 'smooth' }); }}
            >
              Top Rated
            </a>
            <Link
            ...
            {user && (
              <div className="pt-2 border-t border-neutral-800 mt-2">
                <div className="flex items-center justify-between px-2">
                  <span className="text-neutral-400 text-sm">Logged in as <span className="text-white font-medium">{user.username}</span></span>
                  <button 
